...
<template>
  <footer class="relative w-full bg-black text-white overflow-hidden font-inter">
    ...
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
        ...
        <div class="sm:col-span-2 lg:col-span-1">
          ...
          <ul class="space-y-3 sm:space-y-4">
            ...
            <li class="flex items-start gap-2 sm:gap-3 text-gray-400 text-sm sm:text-base">
              ...
              <a href="mailto:Hodaeiihamidreza@gmail.com" class="hover:text-white transition-colors break-all">
                Hodaeiihamidreza@gmail.com
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="max-w-2xl mx-auto text-center">
          ...
          <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto px-4">
            <input 
              ...
              class="flex-1 px-4 sm:px-5 py-2.5 sm:py-3 bg-white/5 border border-gray-700 rounded-lg focus:outline-none focus:border-white transition-colors text-sm sm:text-base"
            >
            <button 
              type="submit"
      ...
      <div class="pt-8 sm:pt-10 md:pt-12 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
        <p class="text-gray-500 text-xs sm:text-sm text-center md:text-left order-2 md:order-1">
          © 2025 Hamidreza Hodaei. All rights reserved.
        </p>
